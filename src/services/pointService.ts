  ...
  getPoints() {
    return [
      ...
      },
      {
        ...
        description: {
          en: "",
          cs: "Muzeum pekařství a mlynářství Božetice<span class='color0'><br/><br/>Božetice 24, Milevsko, tel: 777 197 336, 777 197 331<br/><span class='bold'>www.muzeumbozetice.cz</span><br/>info@muzeumbozetice.cz</span>"
        },
        images: [
          "8.jpg"
        ]
